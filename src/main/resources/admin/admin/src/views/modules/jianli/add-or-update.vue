               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就业信息唯一编号" prop="jianliUuidNumber">
                       <el-input v-model="ruleForm.jianliUuidNumber"
                                 placeholder="就业信息唯一编号" clearable  :readonly="ro.jianliUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就业信息名称" prop="jianliName">
                       <el-input v-model="ruleForm.jianliName"
                                 placeholder="就业信息名称" clearable  :readonly="ro.jianliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jianliUuidNumber: [
                              { required: true, message: '就业信息唯一编号不能为空', trigger: 'blur' },
                          ],
                   jianliName: [
                              { required: true, message: '就业信息名称不能为空', trigger: 'blur' },
                          ],
                   jianliXingming: [
