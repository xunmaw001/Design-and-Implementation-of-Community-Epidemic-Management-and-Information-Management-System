    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='gongzuorenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="社区工作人员名称" prop="gongzuorenyuanName">
                        <el-input v-model="gongzuorenyuanForm.gongzuorenyuanName"
                                  placeholder="社区工作人员名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="社区工作人员名称" prop="gongzuorenyuanName">
                            <el-input v-model="ruleForm.gongzuorenyuanName"
                                      placeholder="社区工作人员名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='gongzuorenyuan' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="就业状态" prop="jiuyeValue">
                        <el-input v-model="yonghuForm.jiuyeValue"
                                  placeholder="就业状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作名称" prop="gongzuotuisongName">
                       <el-input v-model="ruleForm.gongzuotuisongName"
                                 placeholder="工作名称" clearable  :readonly="ro.gongzuotuisongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="工作名称" prop="gongzuotuisongName">
                           <el-input v-model="ruleForm.gongzuotuisongName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="工作类型" prop="gongzuotuisongTypes">
                        <el-select v-model="ruleForm.gongzuotuisongTypes" :disabled="ro.gongzuotuisongTypes" placeholder="请选择工作类型">
                            <el-option
                                v-for="(item,index) in gongzuotuisongTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="工作类型" prop="gongzuotuisongValue">
                        <el-input v-model="ruleForm.gongzuotuisongValue"
                            placeholder="工作类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="工作详情" prop="gongzuotuisongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gongzuotuisongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongzuotuisongContent" label="工作详情" prop="gongzuotuisongContent">
                            <span v-html="ruleForm.gongzuotuisongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    gongzuotuisongName: false,
                    gongzuotuisongTypes: false,
                    insertTime: false,
                    gongzuotuisongContent: false,
                    gongzuotuisongDelete: false,
                },
                ruleForm: {
                    gongzuorenyuanId: '',
                    yonghuId: '',
                    ...
                    gongzuotuisongTypes: '',
                    insertTime: '',
                    gongzuotuisongContent: '',
                    gongzuotuisongDelete: '',
                },
                gongzuotuisongTypesOptions : [],
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gongzuotuisong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gongzuotuisongTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.gongzuotuisongContent = _this.ruleForm.gongzuotuisongContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.gongzuotuisongContent = this.ruleForm.gongzuotuisongContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`gongzuotuisong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gongzuotuisongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
