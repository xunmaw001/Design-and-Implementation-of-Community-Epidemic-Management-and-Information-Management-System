<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='gongzuorenyuan'"  label='社区工作人员名称' prop="gongzuorenyuanName">
               <el-input v-model="ruleForm.gongzuorenyuanName"  placeholder='社区工作人员名称' clearable></el-input>
           </el-form-item>
         </el-col>
