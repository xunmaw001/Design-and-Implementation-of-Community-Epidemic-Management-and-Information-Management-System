    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区待就业人员信息管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="社区工作人员名称" class="input" v-if="tableName=='gongzuorenyuan'">
                            <el-input v-model="ruleForm.gongzuorenyuanName" autocomplete="off" placeholder="社区工作人员名称"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.gongzuorenyuanName)&& 'gongzuorenyuan'==this.tableName){
                                this.$message.error('社区工作人员名称不能为空');
                                return
                            }
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
        ...
        background-image: url(/shequdaijiuyerenyuan/img/back-img-bg.jpg);
