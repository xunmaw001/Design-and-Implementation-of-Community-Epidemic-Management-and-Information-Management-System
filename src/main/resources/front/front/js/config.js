...
var centerMenu = [
    ...
    ,{
        name: '工作推送信息',
        url: '../gongzuotuisong/list.html'
    }
    ,{
        name: '就业信息',
        url: '../jianli/list2.html'
    }
    ,{
        name: '职位收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequdaijiuyerenyuan/admin/dist/index.html#/login";
